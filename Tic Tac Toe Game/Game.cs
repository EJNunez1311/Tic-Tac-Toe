...
namespace Tic_Tac_Toe_Game
{
    public partial class Game : Form
    {
        ...
        //Es responsable de recebir el mensaje (La posicion del jugador)
        ...
        //Espera para recibir el mensaje que es enviado por el oponente. y ese mensaje contiene el boton que jugó el oponente.
